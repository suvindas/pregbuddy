...
public class Z_CheckedTextView extends android.support.v7.widget.AppCompatCheckedTextView {

    public Z_CheckedTextView(Context context) {
        super(context);
    ...
    public Z_CheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (isInEditMode()) return;
    ...
    public Z_CheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
